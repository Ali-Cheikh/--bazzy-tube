        ...
        .then(data => {
            if (data.result === 'success') {
                Swal.fire({
                    ...
                    imageAlt: "Custom Success Icon",
                    title: 'Success!',
                    html: `Your Registration is complete download the code <button class="btn-primary bg-yellow-400 text-black-10 text-lg p-2 rounded" onclick="downloadTicket()">Download Ticket</button> your Ticket `,
                    width: 600,
                    padding: "3em",
                    timer: 5000,
                    timerProgressBar: true,
